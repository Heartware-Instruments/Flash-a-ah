...
var app = new Vue({
	...
	<div class="logo-glitch">
        ...
        <div>
            <legend>Heartware Firmware Updator</legend>
            <p> Connect to the LiveCut - If this is your first time here, follow the steps in Help section below </p>
                    ...
                    <div class="nested_list">
                        ...
                        <ol>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><p>Select a module and firmware version</p></li>
                                </ul>
                            </li>
